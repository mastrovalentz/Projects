...
HD_PWD='/home/student03/projects/mux21/mux21.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux21.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux21.tcl
