...
HD_PWD='/home/student03/projects/mux21/mux21.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux21.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux21.tcl -notrace
