...
HD_PWD='/home/student03/projects/mux41/mux41.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux41.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux41.tcl -notrace
