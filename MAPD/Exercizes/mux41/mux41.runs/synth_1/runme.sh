...
HD_PWD='/home/student03/projects/mux41/mux41.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux41.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux41.tcl
