...
HD_PWD='/home/student03/projects/fsm_counter/fsm_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fsm_counter.tcl -notrace
