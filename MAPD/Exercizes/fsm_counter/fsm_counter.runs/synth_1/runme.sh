...
HD_PWD='/home/student03/projects/fsm_counter/fsm_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fsm_counter.tcl
