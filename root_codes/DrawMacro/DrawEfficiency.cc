...
void DrawEfficiency( TH1F* h11,  TH1F* h21, int r=1, double xmax=0.25){
  ...
  RooRealVar e    ( "e"    , "efficiency", 0.0, 2.5 , "" );
  ...
  data.plotOn(frame) ;
  pol2.fitTo(data, Range("eRange"),SumW2Error(kTRUE), Extended(kFALSE)) ;
